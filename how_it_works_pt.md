...
## Passo 2: Carregar os relatórios PDF (mais-valias, dividendos e juros)
1. Carregue todos os relatórios PDF relevantes das suas corretoras. Neste momento, são suportadas a XTB, a Trade Republic, a Trading 212, o ActivoBank e a Freedom24 (alguns valores ainda não são importados, valide as limitações na página principal)
